...
/* let's create a View which is a virtual tables.  
 * The point about view is that is does not create new data, it merely fetchess the results 
 * of query in which it is defined.
 * 
 * Also administrator/root can give privilege to users about different views which is great for security issues
 *  
 * */
...
SELECT * FROM health_dept_earning_status hdes;
