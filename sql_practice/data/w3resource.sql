-- database from https://www.w3resource.com/sql/sql-table.php
...
-- NUMBER(6,2) refers to 10digits in total with 2 digit decimals: 
-- the corresponding Mysql syntax is DECIMAL(6,2)
...
CREATE TABLE  CUSTOMER(
	...
	AGENT_CODE VARCHAR(10) NOT NULL REFERENCES AGENTS(AGENT_CODE)
);   
